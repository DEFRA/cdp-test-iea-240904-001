...
```bash
docker build --target development --no-cache --tag cdp-test-iea-240904-001:development .
```

Run:

```bash
docker run -p 3000:3000 cdp-test-iea-240904-001:development
```
...
```bash
docker build --no-cache --tag cdp-test-iea-240904-001 .
```

Run:

```bash
docker run -p 3000:3000 cdp-test-iea-240904-001
```
